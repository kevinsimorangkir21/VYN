    ...
    <div className="">
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        <p className="text-sm text-[#d3d8e8]">
          {"If you have any questions or concerns, please feel free to contact me. I am open to any job opportunities that match my skills and interests."}
        </p>
